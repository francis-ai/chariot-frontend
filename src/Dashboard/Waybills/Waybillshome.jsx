  ...
  const fetchWaybills = async () => {
    try {
      ...
      const mappedWaybills = res.data.map(wb => ({
        ...
        driver: wb.driver || wb.delivered_by || "",
        vehicle: wb.vehicle || wb.mode_of_delivery || "",
        quotation_ids: wb.quotation_ids || wb.quotation_id || "",
        invoice_ids: wb.invoice_ids || wb.invoice_id || "",
        product_list: wb.product_list || wb.items || "",
