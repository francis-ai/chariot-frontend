  ...
  return (
    <>
      ...
      <div className="invoice max-w-[850px] mx-auto p-10 bg-white text-[13px] text-gray-800 font-sans leading-tight shadow-lg my-6 border border-gray-200 print:shadow-none print:border-none print:my-0 print:p-0">
        ...
        <h2 className="text-center font-bold text-base underline mb-4">
          INVOICE
        </h2>
        ...
        <table className="w-full border-collapse border border-gray-800">
          <thead>
            <tr>
              <th className="border border-gray-800 p-1 text-left w-10">No.</th>
              <th className="border border-gray-800 p-1 text-left w-24">Item Code</th>
              ...
              <th className="border border-gray-800 p-1 text-right w-28">
                Unit Price (NGN)
              </th>
              <th className="border border-gray-800 p-1 text-right w-28">
                Total (NGN)
          ...
          <tbody>
            {invoiceData.items.map((item, idx) => (
              <tr key={idx} className="min-h-[100px]">
                <td className="border border-gray-800 p-1 align-top">{item.no}</td>
                <td className="border border-gray-800 p-1 align-top">{item.code}</td>
                <td className="border border-gray-800 p-1 font-bold">
                  {item.description}
                </td>
                <td className="border border-gray-800 p-1 text-center align-top">
                  {item.qty}
                </td>
                <td className="border border-gray-800 p-1 text-right align-top">
        ...
        <div className="flex justify-end">
          <div className="w-1/2">
            ...
            <div className="grid grid-cols-2 border-x border-b border-gray-800 p-1">
              <span className="font-bold text-right pr-4">Net Total</span>
              <span className="font-bold text-right">
        ...
        <div className="mt-20 pt-8 border-t border-gray-300">
          <div className="flex justify-between text-[10px] text-gray-500">
            <p>
              Copyright © CHARIOT LINK TECH. & IND. PRODUCTS LTD. ® 2023.
            </p>
            <p>Page 1 of 1</p>
          </div>
